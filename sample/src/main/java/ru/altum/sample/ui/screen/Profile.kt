...
@Serializable
internal class Profile(val value: String) : AnimatedDestination {
    @Composable
...
internal class ProfileViewModel @Inject constructor(
    ...
    private val args = savedStateHandle.requiredArgs<Profile>()
    ...
    fun onSettingsClick() {
        appRouter.navigateTo(Settings(_textState.value))
    }

    fun onBackClick() = appRouter.back().also {
        appRouter.setResult("HomeResult", HomeResult())
    }
}
