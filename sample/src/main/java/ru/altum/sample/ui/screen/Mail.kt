...
@Serializable
internal class Mail(val value: String) : AnimatedDestination {
    @Composable
...
@HiltViewModel
internal class MailViewModel @Inject constructor(
    savedStateHandle: SavedStateHandle,
    private val appRouter: AppRouter,
) : ViewModel() {

    private val args = savedStateHandle.requiredArgs<Mail>()
...
@Composable
internal fun MailScreen(viewModel: MailViewModel = hiltViewModel()) {
